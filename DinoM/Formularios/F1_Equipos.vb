...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarEquipo(tbCodigoOriginal.Text, tbNombre.Text, cbGrupo.Value, cbParametroTecnico.Value, tbNota.Text, TablaImagenes, CType(grDetalle.DataSource, DataTable))
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnModificarEquipo(tbCodigoOriginal.Text, tbNombre.Text, cbGrupo.Value, cbParametroTecnico.Value, tbNota.Text, TablaImagenes, CType(grDetalle.DataSource, DataTable))
        If res Then
